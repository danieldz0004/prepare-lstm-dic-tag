...
//        cu.addWord();
    ...
    public  ClearUnknown() {
        knownKeepList = new ArrayList<String>();
        tagString = new ArrayList<String>();
        unknownKeepList = new ArrayList<String>();
...
//                        System.out.println(text.substring(0, 1));
                ...
                //找到词语在一句话中开始的位置
                for (int i = startIndex; i < label.size(); i++) {
                ...
                //找到词语在一句话中结束的位置
                for (int j = startIndex + 1; j < label.size(); j++) {
